...
class TaskGatlingTest extends Simulation {
    ...
    val scn = scenario("Test the Task entity")
        ...
        .repeat(2) {
            ...
            .get("/jhipstersample2application/api/tasks")
            .headers(headers_http_authenticated)
            .check(status.is(200)))
            .pause(10 seconds, 20 seconds)
            .exec(http("Create new task")
            .post("/jhipstersample2application/api/tasks")
            .headers(headers_http_authenticated)
            .body(StringBody("""{
                "id":null
                , "title":"SAMPLE_TEXT"
            ...
            .repeat(5) {
                ...
                .get("/jhipstersample2application${new_task_url}")
                .headers(headers_http_authenticated))
                .pause(10)
            }
            .exec(http("Delete created task")
            .delete("/jhipstersample2application${new_task_url}")
            .headers(headers_http_authenticated))
            .pause(10)
        }
