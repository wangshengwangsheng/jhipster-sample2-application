...
class CountryGatlingTest extends Simulation {
    ...
    val scn = scenario("Test the Country entity")
        ...
        .repeat(2) {
            ...
            .get("/jhipstersample2application/api/countries")
            .headers(headers_http_authenticated)
            .check(status.is(200)))
            .pause(10 seconds, 20 seconds)
            .exec(http("Create new country")
            .post("/jhipstersample2application/api/countries")
            .headers(headers_http_authenticated)
            .body(StringBody("""{
                "id":null
            ...
            .repeat(5) {
                ...
                .get("/jhipstersample2application${new_country_url}")
                .headers(headers_http_authenticated))
                .pause(10)
            }
            .exec(http("Delete created country")
            .delete("/jhipstersample2application${new_country_url}")
            .headers(headers_http_authenticated))
            .pause(10)
        }
