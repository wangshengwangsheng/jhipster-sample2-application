...
class RegionGatlingTest extends Simulation {
    ...
    val scn = scenario("Test the Region entity")
        ...
        .repeat(2) {
            ...
            .get("/jhipstersample2application/api/regions")
            .headers(headers_http_authenticated)
            .check(status.is(200)))
            .pause(10 seconds, 20 seconds)
            .exec(http("Create new region")
            .post("/jhipstersample2application/api/regions")
            .headers(headers_http_authenticated)
            .body(StringBody("""{
                "id":null
            ...
            .repeat(5) {
                ...
                .get("/jhipstersample2application${new_region_url}")
                .headers(headers_http_authenticated))
                .pause(10)
            }
            .exec(http("Delete created region")
            .delete("/jhipstersample2application${new_region_url}")
            .headers(headers_http_authenticated))
            .pause(10)
        }
