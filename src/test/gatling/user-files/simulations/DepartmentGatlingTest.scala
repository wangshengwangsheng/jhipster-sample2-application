...
class DepartmentGatlingTest extends Simulation {
    ...
    val scn = scenario("Test the Department entity")
        ...
        .repeat(2) {
            ...
            .get("/jhipstersample2application/api/departments")
            .headers(headers_http_authenticated)
            .check(status.is(200)))
            .pause(10 seconds, 20 seconds)
            .exec(http("Create new department")
            .post("/jhipstersample2application/api/departments")
            .headers(headers_http_authenticated)
            .body(StringBody("""{
                "id":null
            ...
            .repeat(5) {
                ...
                .get("/jhipstersample2application${new_department_url}")
                .headers(headers_http_authenticated))
                .pause(10)
            }
            .exec(http("Delete created department")
            .delete("/jhipstersample2application${new_department_url}")
            .headers(headers_http_authenticated))
            .pause(10)
        }
